...
- **Wang, R.**, Osom, A., Zhang, B. (2026+). Generalized projection tests for function-valued parameters with applications to testing structural causal assumptions. [arXiv](https://arxiv.org/abs/2603.13681)
...
1. **Wang, R.**, Heagerty, P., Chan, KCG., Suri, P. (2026). Estimating controlled direct treatment effects on pain intensity using structural mean models: a general approach for pain randomized controlled trials. *Pain Reports*.  [DOI](http://dx.doi.org/10.1097/PR9.0000000000001409)

2. Deng, Y., **Wang, R.**, Zhang, T., Zhan, X. (2026+). Randomized interventional effects for semicompeteting risks, with application to allogeneic stem cell transplantation study.  *Statistics in Medicine* (in press).
